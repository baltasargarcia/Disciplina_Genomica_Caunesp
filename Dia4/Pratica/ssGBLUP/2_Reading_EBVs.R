...
setwd("C:/Post_Doc_UNESP/Cursos_congressos_discip/Disciplina_Caunesp_2025/Dia4/Pratica/ssGBLUP/All")
...
for(i in 1:5) {
  ...
  setwd(paste0("C:/Post_Doc_UNESP/Cursos_congressos_discip/Disciplina_Caunesp_2025/Dia4/Pratica/ssGBLUP/CV", i))
